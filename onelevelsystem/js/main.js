...
/**
Slider JS Commands. I, Harsh Patel, do not take ownership of this file. This has been created and developed by codrops.
*/
...
;(function(window) {
	...
	function initEvents() {
		// open items
		zoomCtrl.addEventListener('clidck', function() {
